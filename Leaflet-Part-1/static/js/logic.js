...
d3.json(dataURL).then(jsonData => {
    // Call the function to generate the Leaflet Map using all key-value pairs from the 'features' key of the JSON dataset
    init_quakeMap(jsonData.features);
});
...
const init_quakeMap = (quakeData) => {     
    ...
    // Create and apply the base layer to the Leaflet Map Object
